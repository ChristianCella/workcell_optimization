...
plt.plot(range(1, len(turbo_vals)+1), turbo_vals, linewidth=2, label=r"\texttt{TuRBO}")
plt.plot(range(1, len(cma_es_vals)+1), cma_es_vals, linewidth=2, label=r"\texttt{cma-es}")

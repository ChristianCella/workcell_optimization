...
plt.plot(df_turbo_ikflow['fitness'], label=r'$\texttt{TuRBO_{ik}}$', linewidth=2)
plt.plot(df_cmaes_ikflow['fitness'], label=r'$\texttt{cma-es_{ik}}$', linewidth=2)
plt.plot(df_turbo_bioik2['fitness'], label=r'$\texttt{TuRBO_{bioik2}}$', linewidth=2)

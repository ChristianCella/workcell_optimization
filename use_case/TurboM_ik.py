...
if __name__ == "__main__":
    ...
    batch_size = 40 #10
    max_evals = 4420  # 140 (n_init*trust_regions)+40(batch_size/popsize)*100(n_val)
    n_init =  28 #80 # max(2 * lb.size, batch_size) sarebbe opportuno 2*d 48
    use_ard = True
    n_training_steps = 50  # GP training iters per update
    verbose = True
    n_trust_regions = 15 #5  # Number of trust regions to maintain
